...
public class VanEmdeBoasMap<E> implements NavigableMap<Integer, E> {
    ...
    public E successorObject(int key){
        E obj = map.get(root.successor(key));
        if (obj == null){
            return map.get(root.successor(0));
        }
        return obj;
    }
    ...
    public int successor(int key){
        ...
        if (successor == -1){
            return root.successor(0);
        }
        return successor;
    }
    public E predecessorObject(int key){
        E obj = map.get(root.predecessor(key));
        if (obj == null){
            return map.get(root.predecessor(this.universeSize));
        }
        return obj;
    }
    ...
    public int predecessor(int key){
        ...
        if (predecessor == -1 ){
            return root.predecessor(this.universeSize);
        }
        return predecessor;
    }

    public E getObject(int key){
        return map.get(key);
    }
